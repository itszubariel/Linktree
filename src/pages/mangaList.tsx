...
export function MangaList() {
  ...
  useEffect(() => {
    fetch("/manga_data.json")
      ...
      .then((cache) => {
        setData(
          (cache.manga as Record<string, unknown>[]).map((m) => ({
            title: m.title as string,
            japanese_title: (m.japanese_title as string) || "",
            status: m.status as string,
            genres: m.genres as string[],
            rating: m.rating as number | undefined,
            chapters: m.chapters as number | undefined,
            image_url: m.image_url as string,
            synopsis: (m.synopsis as string) || "",
            mal_score: m.mal_score as number | undefined,
            type: (m.type as string) || "",
            year: m.year as number | undefined,
          })),
        );
      })
      .catch((err) => console.error("Failed to load manga_data.json:", err))
  ...
  const stats = useMemo(() => {
    ...
    return {
      ...
      reading: data.filter((a) => a.status === "reading").length,
      avg,
    };
  }, [data]);
  ...
  return (
    <main>
      <Seo
        title="Zubariel | Manga List"
        ogTitle="Manga List"
        description="Every manga read, dropped, or queued tracked since 2015."
        keywords="manga, list, myanimelist, zubariel"
      />

      <section className="anime-hero">
        <p className="anime-eyebrow">Personal Collection</p>
        <h1 className="anime-title">
          My <span className="gradient-word">Manga</span> List.
        </h1>
        <p className="anime-sub">
          Every manga read, dropped, or queued tracked since 2015.
        </p>
        <div className="anime-stats">
          ...
          <div className="anime-hs">
            <span className="anime-hs-n">{stats.reading}</span>
            <span className="anime-hs-l">Reading</span>
          </div>
          <div className="anime-hs">
        ...
        <div className="anime-ctrl-inner">
          ...
          <div className="anime-frow">
            ...
            >
              ...
              <option value="ch">Most Chapters</option>
            </select>
            <button
      ...
      <div className="anime-gsection">
        <div className="anime-grid">
          {!loaded ? (
            <div className="anime-empty">Loading manga list…</div>
          ) : !items.length ? (
          ...
          <div className="anime-detail" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="anime-d-body">
              ...
              <div className="anime-d-stats">
                ...
                <div className="anime-ds">
                  <span className="anime-ds-v">{sel.chapters || "?"}</span>
                  <span className="anime-ds-k">Chapters</span>
                </div>
                {sel.year ? (
                  <div className="anime-ds">
            ...
            <div className="anime-i-body">
              ...
              <div className="anime-i-grid">
                <div className="anime-istat">
                  <div className="anime-istat-v">232</div>
              ...
              <div className="anime-i-details">
                <div className="anime-irow">
                  <span className="anime-ik">Favorite Manga</span>
                  <span className="anime-iv">Bleach</span>
                </div>
                <div className="anime-irow">
                  <span className="anime-ik">Current Fav</span>
                  <span className="anime-iv">Blue Box</span>
                </div>
                <div className="anime-irow">
                  <span className="anime-ik">Favorite Genre</span>
                  <span className="anime-iv">Shounen / Seinen</span>
                </div>
                <div className="anime-irow">
                  <span className="anime-ik">Reading Since</span>
              ...
              <div className="anime-i-links">
                <Link className="anime-ilink" to="/anime-list">
                  Anime List
                </Link>
                <a
